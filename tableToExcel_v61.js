    ...
    downloadButton.addEventListener('click', (event) => {
      ...
      var rows = table.rows;
        ...
        //   cell.setAttribute('style');
          ...
          var ctx = { Worksheet: '26', table: "<tr class='table-header'><caption class='table-header' rowspan='1' style='height: 40px;border: 1px solid black;background-color: #eee;font-family: Verdana;'><b>C 26.00 - Large Exposures limits (LE Limits)</b></caption></tr><tr class='table-header'><th class='table-header' rowspan='1' colspan='3' style='background-color:none !important;font-family:Verdana;font-size:10px;align-items: center;text-align: right;padding: 5px;'>* All values reported are in millions </th></tr>"+table.innerHTML }

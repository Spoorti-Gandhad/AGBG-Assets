      ...
      downloadButton.addEventListener('click', () => { 
        ...
        // });
          ...
          var tableData =  "<tr class='table-header'>
                        ...
                        <tr class='table-header'><th class='table-header' rowspan='1' colspan='3' style='background-color:none !important;font-family:verdana;font-size:10px;align-items: center;text-align: left;padding: 5px;color:grey;font-weight:normal;'>* All are in millions </th>
                        </tr>"+htmlTable;
